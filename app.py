...
def conectar_gsheet():
    ...
    # Carrega todas as worksheets uma única vez e guarda em dicionário
...
def ler_aba_com_cabecalho(mapa_abas, nome_aba, colunas_esperadas):
    ...
    # Ajusta linhas com tamanhos diferentes
    linhas_ajustadas = []
...
try:
    ...
    st.error("Arquivo de credenciais não encontrado. Verifique se 'credenciais_google.json' está na mesma pasta do app.py.")
